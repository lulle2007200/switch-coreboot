...
#define CLOCK(off) (*((volatile uint32_t *)(CLOCK_BASE + (uintptr_t)off)))
#define MC(off) (*((volatile uint32_t *)(MC_BASE + (uintptr_t)off)))
#define EMC(off) (*((volatile uint32_t *)(EMC_BASE + (uintptr_t)off)))
#define EMC_CH0(off) (*((volatile uint32_t *)(EMC0_BASE + (uintptr_t)off)))
