...
#ifndef _TEGRA_SC7_ENTRY_H_
#define _TEGRA_SC7_ENTRY_H_
...
#define RES_SEMA_BASE 0x60001000
#define IRQ_CTLR_BASE 0x60004000
...
#define RES_SEMA(off) _REG(RES_SEMA_BASE, off)
#define IRQ_CTLR(off) _REG(IRQ_CTLR_BASE, off)
...
#define I2C5(off) _REG(I2C5_BASE, off)
...
#define SOC_THERM(off) _REG(SOC_THERM_BASE, off)
...
/*! IRQ_CTLR registers. */
#define IRQ_CONTROLLER(off) (off << 8)
#define ICTLR_ISR 0x10
#define ICTLR_COP_IER_CLR 0x38
#define  PRI_ICTLR_FC_INT (1 << 25)
...
#define FLOW_CTLR_FC_SEQUENCE_INTERCEPT 0x5C
#define  INTERRUPT_PENDING_CRAIL 0x40
...
#define  SIGN_OF_LIFE 0xAAAAAAAA

#define SOC_THERM_TSENSOR_VALID 0x1E0
