...
#else
	{OP_SET, 0x6000632C, 0xfcfeff3e},	/* CLK_ENB_H_CLR Preserve DSI and MIPI_CAL */
	{OP_SET, 0x60006328, 0x020000c1},	/* CLK_ENB_H_SET Preserve DSI and MIPI_CAL */
	{OP_SET, 0x60006324, 0x67bdfecf},	/* CLK_ENB_L_CLR Preserve DISP1, HOST1X and PWM */
	{OP_SET, 0x60006320, 0x80400130},	/* CLK_ENB_L_SET Preserve DISP1, HOST1X and PWM */
#endif
...
#else
	{OP_SET, 0x6000644C, 0xbfd7ff03},	/* CLK_ENB_W_CLR Preserve DSIA_LP */
	{OP_SET, 0x60006448, 0x402000fc},	/* CLK_ENB_W_SET Preserve DSIA_LP */
	{OP_SET, 0x60006288, 0xdcfdf87f},	/* CLK_ENB_X_CLR Preserve UART_FST_MIPI_CAL */
	{OP_SET, 0x60006284, 0x23000780},	/* CLK_ENB_X_SET Preserve UART_FST_MIPI_CAL */
#endif
